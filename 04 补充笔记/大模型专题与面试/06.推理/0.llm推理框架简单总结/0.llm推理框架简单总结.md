...
ct2-transformers-converter --model huggyllama/llama-13b --output_dir outputs/chapter-04/llama-13b-ct2 --force
```
...
generator = ctranslate2.Generator("outputs/chapter-04/llama-13b-ct2", device="cuda", compute_type="float16")
