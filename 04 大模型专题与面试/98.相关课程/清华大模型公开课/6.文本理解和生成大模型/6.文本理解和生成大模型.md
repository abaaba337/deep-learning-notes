...
![](../../../images/image_kj2z6nEids.png)

## 1.2 信息检索

信息检索是非常古老、非常经典的任务。在这一方面，大模型可以帮助机器来提供更加智能、更加准确的搜索结果。

![](../../../images/image_FqazwCbO7r.png)
...
![](../../../images/image_gspSV1YlTD.png)

## 1.4文本生成

利用大模型可以帮助机器生成更加流畅、自然的文本。

![](../../../images/image_M5q0B0YeoC.png)
...
![](../../../images/image_LgevrcusN-.png)

其次是**语义失配**问题，可能即使文档和词汇有很高的匹配率，但描述的含义却完全不一样。

![](../../../images/image_wt9odGLEqL.png)
...
![](../../../images/image_kIGwLZVKar.png)

BiDAF就是遵循了上面的框架实现的模型。

> Seo et al., Bidirectional Attention Flow for Machine Comprehension, In Proceedings of ICLR 2017

![](../../../images/image_it24oL9Cej.png)
...
![](../../../images/image_bcXrI_A_aA.png)

有**条件的语言建模**，不仅基于已经生成的词，还基于其他输入。比如机器翻译。

![](../../../images/image_mICC1Cdk22.png)
...
![](../../../images/image_GZ0iWgIIU-.png)

以GPT-2为例，**它是在无标签的数据上训练的，可以根据下游具体的有标签数据进行微调**。

![](../../../images/image_OA1-TdYx_P.png)
...
![](../../../images/image_N88MOU077W.png)

![](../../../images/image_ILs9cnbiZB.png)
...
![](../../../images/image_-PaS3GGug9.png)

![](../../../images/image_Nmbakd0TKx.png)

### （2）其他方法

除了通用的方法外， 还有其他的测量矩阵。比如基于距离可以测量文本的余弦相似度。

![](../../../images/image_My2mZJeP_X.png)
