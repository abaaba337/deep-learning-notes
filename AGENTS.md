...
- 01–04 构成学习路径：01 神经网络基础，02 PyTorch 与图像任务，03 序列建模与 Transformer，04 补充笔记。
- 02 按 FNN → OpenCV → CNN → U-Net → 去噪；03 从 RNN/LSTM/时序开始，再到注意力、Transformer、训练目标、稳定性、微调、压缩、强化学习、对齐和评估。
- 各章 README 提供导航；04 下 concepts.md 和 coding.md 分别承担概念问答与代码解析，大模型专题与面试、数据结构与算法作为无编号子目录，配图统一放本章 images。
